    ...
    def train(self, dataset):
        ...
        while self._epoch < self._epochs:
            ...
            for _ in range(self._n_critic):
                ...
                losses = self._critic_model.train_on_batch(inputs, [ones, neg_ones, placeholder])
            ...
            print("%d [C loss: %+.6f] [G loss: %+.6f] [AE loss: %+.6f]" % (
            self._epoch, critic_loss, generator_loss, ae_loss))
