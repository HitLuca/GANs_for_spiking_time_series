...
class AE:
    def __init__(self, config):
        ...
        self._decoder_type = config['decoder_type']
    ...
    def _build_models(self):
        self._encoder = ae_utils.build_encoder(self._latent_dim, self._timesteps, self._encoder_type)
        self._decoder = ae_utils.build_decoder(self._latent_dim, self._timesteps, self._decoder_type)
        self._ae_model, self._generator = ae_utils.build_ae_model(self._encoder, self._decoder,
                                                                  self._latent_dim,
    ...
    def train(self, dataset):
        while self._epoch < self._epochs:
            ...
            ae_loss = self._ae_model.train_on_batch(batch_transactions, batch_transactions)
    ...
    def _save_losses(self):
        utils.save_losses_other(self._losses, self._img_dir + '/losses.png', 'ae')
    ...
    def get_models(self):
        return self._encoder, self._decoder, self._generator, self._ae_model
